...
var createSlideshow = function () {
    ...
    var timer, play = true, nodes, img, stopSlideShow, displayNextImage, setPlayText, setSpeed;
   ...
   // function setSpeed() {
     //   document.getElementById("set_speed")
       
    //}
    setSpeed = function (btn) {
        window.prompt("Hello");
    };
    //my starting attempt here
    /*setSpeed = function (btn) {
        var speed = document.getElementById("set_speed");
        if (speed.value !== "") {
            window.prompt("Set your speed here.");
        } else {
            window.prompt("You've entered an invalid number. Please try again.");
        }
        return this;
       // window.prompt.alert(speed("Set your speed"));*/
    };
    ...
    return {
        ...
        //INCOMPLETE NONSENSE HERE - Heeeellpppp
