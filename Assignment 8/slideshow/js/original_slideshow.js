...
var createSlideshow = function () {
    ...
    var speed = 2000;
    /*
    setSpeed = document.getElementById("set_speed");
    setSpeed.onclick = function () {
        window.alert("Hajimimashte");
    };*/
    /*
    setSpeed = function () {
        "use strict";
    ...
    return {
        ...
        startSlideShow: function () {
            ...
            timer = setInterval(displayNextImage, 2000);//replace with setInteval in assignment
            return this;
        },
...
function setSpeed() {
    "use strict";
    var speed = window.prompt("Choose your speed.");
}
...
//assign a new public function and move to the bottom (also use onclick), add a variable #3 at the top
    //don't delete his code